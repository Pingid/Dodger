...
/***/ function(module, exports, __webpack_require__) {
	...
	var subbedToEvents = _mouse2.default.global(_store2.default);
	...
	function update() {
	  ...
	  var mouse = _store$getState.mouse;
	  var game = _store$getState.game;
	
	  ctx.clearRect(0, 0, window.innerWidth, window.innerHeight);
	  if (!game.ended) {
	    if (mouse.down) {
	      game.ball.update(mouse.currentPosition);
	      game.objects.forEach(function (block) {
	        block.update();
	      });
	    }
	    game.ball.draw();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mouseReducer = __webpack_require__(16);
	
	var _mouseReducer2 = _interopRequireDefault(_mouseReducer);
	
	var _gameReducer = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.global = function () {
	  window.addEventListener('mousedown', function (e) {
	    return _store2.default.dispatch({ type: 'MOUSE_DOWN', position: { x: e.pageX, y: e.pageY } });
	  });
	  window.addEventListener('mouseup', function (e) {
	    return _store2.default.dispatch({ type: 'MOUSE_UP', position: { x: e.pageX, y: e.pageY } });
	  });
	  window.addEventListener('mousemove', function (e) {
	    return _store2.default.dispatch({ type: 'MOUSE_MOVE', position: { x: e.pageX, y: e.pageY } });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _generateBlocks = __webpack_require__(23);
	
	var _generateBlocks2 = _interopRequireDefault(_generateBlocks);
	...
	exports.default = function () {
	  ...
	  var ball = new _Ball2.default({ x: global.pageX / 2, y: global.pageY - 100 }, 10, global.context);
	  console.log(ball);
	  _store2.default.dispatch({ type: 'BALL', ball: ball });
	  (0, _generateBlocks2.default)(state);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Ball(position, size, context) {
	  ...
	  this.handlePostion = function () {
	    self.position = (0, _Utils.subVector)(self.position, self.velocity);
	  };
	  this.draw = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function generateBlocks(context) {
	  ...
	  var mouse = _store$getState.mouse;
	  var game = _store$getState.game;
	  var global = _store$getState.global;
	
	  if (mouse.down && !game.ended) {
	    var height = Math.random() * 30;
	    var newBlock = new _Block2.default({ x: Math.random() * global.pageX, y: -height }, { x: height, y: height }, global.context);
	    var blocks = game.objects.filter(function (block) {
	      if ((0, _Utils.distance)(block.position, game.ball.position) < game.ball.size + block.dimensions.x) {
	        _store2.default.dispatch({ type: 'GAME_END' });
	      }
	      if (block.position.y > global.pageY) {
	        _store2.default.dispatch({ type: 'SCORE_INC' });
	      };
	      return block.position.y < global.pageY;
	    });
	    _store2.default.dispatch({ type: 'OBJECTS', objects: [].concat(blocks, [newBlock]) });
	  }
